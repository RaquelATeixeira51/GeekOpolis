...
public class UsuarioController {
    ...
    public List<UsuarioPayloadDto> buscaUsuario(@RequestParam(required = false) String emailFiltro) {
        List<UsuarioPayloadDto> u = userService.buscaUsuarios(emailFiltro);
